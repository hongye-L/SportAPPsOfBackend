...
public class UploadController {
    @PostMapping("/upload")
    public ResponseEntity<JSONObject> uploadImageFile(@RequestParam ("file")MultipartFile file,
        ...
        try {
            ...
            if(suffix.equals("jpg") || suffix.equals("jpeg") || suffix.equals("png") || suffix.equals("gif")) {
                ...
                String imgFilePath = "\\pictures\\";//新生成的图片
            ...
            return new ResponseEntity<>(json, HttpStatus.BAD_REQUEST);//500,系统异常
        } catch (Exception e) {
            json.put("STATUS", "ERROR");
